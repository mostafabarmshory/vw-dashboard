...
import MbSeenAbstractCollectionCtrl from './MbSeenAbstractCollectionCtrl';

/**
@ngInject
 */
export default class MbSeenAbstractCollectionViewCtrl extends MbSeenAbstractCollectionCtrl {

	constructor($view, $scope, $q, $mbLog, MbAction, MbComponent) {
		'ngInject';
		super($scope, $q, $mbLog)
